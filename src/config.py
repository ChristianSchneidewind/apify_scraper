...
class AppConfig:
    ...
    max_ui_rounds: int
    ui_idle_rounds: int
    load_timeout_secs: int
    screenshot_timeout_ms: int
    request_handler_timeout_secs: int
    login_enabled: bool
    ...
    debug_har: bool
    debug_devtools: bool
    manual_debug_mode: bool
    manual_debug_only: bool
    manual_debug_pause_secs: int
    safe_interaction_mode: bool
    force_single_concurrency: bool
